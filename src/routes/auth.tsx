...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in | Nearby Chat" },
      { name: "description", content: "Sign in to Nearby Chat." },
      { property: "og:title", content: "Sign in | Nearby Chat" },
      { property: "og:description", content: "Sign in to Nearby Chat." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to start chatting with people nearby.</CardDescription>
          </CardHeader>
          <CardContent>
